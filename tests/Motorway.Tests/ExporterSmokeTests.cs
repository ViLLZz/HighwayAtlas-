...
public sealed class ExporterSmokeTests
{
    ...
    public void HtmlAtlasExport_ContainsAlphaUiControlsAndHemusData()
    {
        ...
        Assert.Contains("family=Fraunces", html, StringComparison.Ordinal);
        Assert.Contains("family=Plus+Jakarta+Sans", html, StringComparison.Ordinal);
        Assert.Contains("family=Space+Grotesk", html, StringComparison.Ordinal);
        ...
        Assert.Contains("getViewportFitSignature", html, StringComparison.Ordinal);
        ...
        Assert.Contains("visualViewport", html, StringComparison.Ordinal);
        ...
        Assert.Contains("top: 82px;", html, StringComparison.Ordinal);
